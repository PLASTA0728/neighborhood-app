...
const Z_INDEX_HOVER = markers.length + 1;
  ...
  const onMarkerClick = useCallback((id: string | null) => {
    setSelectedId(id);
  }, []);
      ...
      return (
        <AdvancedMarkerWithRef
          ...
          <InfoWindow
            ...
            zIndex={selectedId === id ? Z_INDEX_SELECTED : undefined} // bring to front if selected
          >
            <Card
              sessionNo={sessionNo.toString()}
              user={markers.find(m => m.id === id)?.user}
